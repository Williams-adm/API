...
const datos = (personajes) => {
    personajes.forEach(characters => {
        ...
        fetch(urlstories)
            .then(response => response.json())
            .then(response => datostories(response.data.results))
            .catch(error => console.log("Se ha producido un error: ", error))
        /* Accediendo a las stories */
        const datostories = (datastories) => {
            ...
            datastories.forEach(datastorie => {
        ...
        fetch(urlevents)
        .then(response => response.json())
        .then(response => dataevents(response.data.results))
        .catch(error => console.log("Se ha producido un error: ", error))
        /* Accediendo a eventos */
        const dataevents = (dateevents) => {
